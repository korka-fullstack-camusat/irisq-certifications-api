...
from routes import forms, responses, upload, exams, auth, sessions, candidate_auth, audit_logs, correcteurs, comite, admin_documents, formations
...
app.include_router(candidate_auth.router, prefix="/api/candidate", tags=["Candidate"])
